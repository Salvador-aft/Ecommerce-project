...
// Manages navigation links and user interaction within the menu
const BlackMenu = () => {
  const { isAuthenticated, user, logout } = useAuth(); // Retrieves authentication state and user details
              ...
              <Nav>
                {isAuthenticated ? (
                  <Dropdown align="end">
                    ...
                    <Dropdown.Menu>
                      <Dropdown.ItemText>Hi, {user?.name}</Dropdown.ItemText>
